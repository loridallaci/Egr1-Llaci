#!/bin/bash
#
#SBATCH --job-name=new_call_peaks_F_102824_window1000
#SBATCH --output=logs/new_call_peaks_F_102824_window1000.out
#SBATCH --error=logs/new_call_peaks_F_102824_window1000.err
