#!/bin/bash
#
#SBATCH --job-name=new_call_peaks_M_102824_window1000_sorted_downsampled
#SBATCH --output=logs/new_call_peaks_M_102824_window1000_sorted_downsampled.out
#SBATCH --error=logs/new_call_peaks_M_102824_window1000_sorted_downsampled.err
...
UNF=TCGTG_Male_WT_22CNMGLT4_S249_L008_R1_001_map_sort_final_sorted_downsampled.qbed
TF=TCGTG_Male_Egr1_22CNMGLT4_S249_L008_R1_001_map_sort_final_sorted_downsampled.qbed
...
#call peaks
python3 call_peaks_window1000_downsampled.py --unf_input $PROJECT_INS/$UNF --tf_input $PROJECT_INS/$TF --tf_stem $TF_STEM --unf_stem $UNF_STEM --out_stem $PROJECT_OUT --genome $GENOME  
