#!/bin/bash
#
#SBATCH --job-name=new_call_peaks_F_102824_window1000_downsampled_RERUN
#SBATCH --output=logs/new_call_peaks_F_102824_window1000_downsampled_RERUN.out
#SBATCH --error=logs/new_call_peaks_F_102824_window1000_downsampled_RERUN.err
